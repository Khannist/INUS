...
function F_closeReplace(){
    ...
    document.querySelector('#chatIcon_2').style.display = "none";	//닫히는 아이콘 나타남
    document.querySelector('#chatIcon').style.display = "block";	//열리는 아이콘 없어짐  
}
...
function FMusicPage(){
    ...
    document.querySelector('#chatRealsubmit').style.width = "20px";
}
//채팅 옆으로 밀고 뮤직 페이지 등장
