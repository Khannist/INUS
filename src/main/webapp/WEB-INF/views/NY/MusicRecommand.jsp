...
<meta charset="UTF-8">
<title>음악페이지</title>
<link href="css/NY/MusicRecommand.css" rel="stylesheet">
</head>
<body>
<div class="MusicPage">
	<img class="ToIMG" id="ToSearch" src="img/NY/icon/ToSearch.png" onclick="F_ToSearch()">
	...
	<!-- [추천 재생목록] TOP100 -->
		...
		<div class="top100List">
			...
			<ul>
				...
				<li>
					<img src="img/NY/PageImg/koreaTOP100.png" class="top100Img" id="top100Img_1" onclick="showVideo01()">
					<p>KoreaTop100</p>
					<!-- https://music.youtube.com/playlist?list=PLX_q1hyeET2TQLU4PzpVoSVYxsUnhzKaW&feature=share -->
				</li>
				<li >
					<img src="img/NY/PageImg/koreaMVTOP100.png" class="top100Img" id="top100Img_2" onclick="showVideo02()">
					<p>KoreaMVTop100</p>
					<!-- https://music.youtube.com/playlist?list=PLX_q1hyeET2Tbwcw6_aMvbCgv4HRtsaOh&feature=share -->
				</li>
				<li>
					<img src="img/NY/PageImg/globalTOP100.png" class="top100Img" id="top100Img_3" onclick="showVideo03()" >
					<p>GlobalTop100</p>
					<!-- https://music.youtube.com/playlist?list=PLX_q1hyeET2TyTOUo2FFLNG8H3xk5f5mP&feature=share -->
				</li>
				<li>
					<img src="img/NY/PageImg/globalMVTOP100.png" class="top100Img" id="top100Img_4" onclick="showVideo04()">
					<p>GlobalMVTop100</p>
		...
		<div class="keywordList">
			...
			<div class="keyword_Text">
				...
				<ul class="aloneloveList" style="display: none;">
					<li>
						<img src="img/NY/recommandImg/alonelove/aloneloveImg_1.jpg" class="KeyImg" id="aloneloveList_1">
						<p><span>느낌있게</span><br>호랑</p>
					<!-- https://music.youtube.com/playlist?list=PLLmwQXGbsQma6YZfvPvlKXMvZF4_w9Z3A -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/alonelove/aloneloveImg_2.jpg" class="KeyImg" id="aloneloveList_2">
						<p><span>짝사랑</span><br>SIWON KIM</p>
					<!-- https://music.youtube.com/playlist?list=PLtTWdpTTFqZ2cj7-Suj0bAiH98NsCA-FM -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/alonelove/aloneloveImg_3.jpg" class="KeyImg" id="aloneloveList_3">
						<p><span>모던한 분위기</span><br>GONGS</p>
					<!-- https://music.youtube.com/playlist?list=PLTuUy-Y4gMbZ5bJqO9GNTabcltOJD6SHo -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/alonelove/aloneloveImg_4.jpg" class="KeyImg" id="aloneloveList_4">
						<p><span>그냥</span><br>히라</p>
					<!-- https://music.youtube.com/playlist?list=PL9StwatIujD4dXaMH8mHf-8GX3Lx16GX5 -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/alonelove/aloneloveImg_5.jpg" class="KeyImg" id="aloneloveList_5">
						<p><span>😬💗</span><br>SIWON KIM</p>
					<!-- https://music.youtube.com/playlist?list=PLtTWdpTTFqZ3c3XN9jwBdOa-njNXcV09f -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/alonelove/aloneloveImg_6.jpg" class="KeyImg" id="aloneloveList_6">
						<p><span>블루스카이</span><br>베리브라운</p>
					<!-- https://music.youtube.com/playlist?list=PLpasVL6lVA-xdpBCNPgknUo1MvlSUo92A -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/alonelove/aloneloveImg_7.jpg" class="KeyImg" id="aloneloveList_7">
				...
				<ul class="PopArtistList" style="display: none;">
					<li>
						<img src="img/NY/recommandImg/popstar/PopArtistImg_1.jpg" class="KeyImg" id="PopArtistList_1">
					...
					<li>
						<img src="img/NY/recommandImg/popstar/PopArtistImg_2.jpg" class="KeyImg" id="PopArtistList_2">
					...
					<li>
						<img src="img/NY/recommandImg/popstar/PopArtistImg_3.jpg" class="KeyImg" id="PopArtistList_3">
				...
				<ul class="RelaxList" style="display: none;">
					...
					<li>
						<img src="img/NY/recommandImg/Relax/RelaxImg_4.jpg" class="KeyImg" id="RelaxList_4">
						<p><span>포장마차</span><br>서진규</p>
					<!-- https://music.youtube.com/watch?v=9e-jcTNFZiw&list=PLCeBnfR2pp-94hr7qc0i4CNfFm_lp9vgt -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/Relax/RelaxImg_5.jpg" class="KeyImg" id="RelaxList_5">
						<p><span>일소라 차트</span><br>KYLE</p>
					<!-- https://music.youtube.com/playlist?list=PLM2r05RQ64_oSme66CRKm_qnxGQMrJNCZ -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/Relax/RelaxImg_6.jpg" class="KeyImg" id="RelaxList_6">
						<p><span>힘들때</span><br>무진</p>
					<!-- https://music.youtube.com/playlist?list=PLanSAF4vpi9IiX5GKjJ-lk8C2LGOdsG9C -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/Relax/RelaxImg_7.jpg" class="KeyImg" id="RelaxList_7">
				...
				<ul class="ExerciseList" style="display: none;">
					...
					<li>
						<img src="img/NY/recommandImg/Exercise/ExerciseImg_7.jpg" class="KeyImg" id="ExerciseList_7">
				...
				<ul class="leaveworkList" style="display: none;">
					<li>
						<img src="img/NY/recommandImg/leavework/leaveworkImg_1.jpg" class="KeyImg" id="leaveworkList_1">
						<p><span>산뜻한 초저녁</span><br>무</p>
					<!-- https://music.youtube.com/playlist?list=PLJ9y6MY8l9DirjA8ptVi2pwQkxrb0X2jD -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/leavework/leaveworkImg_2.jpg" class="KeyImg" id="leaveworkList_2">
						<p><span>뚝섬 11번출구</span><br>조성민</p>
					<!-- https://music.youtube.com/playlist?list=PLu1e8X5bKBImReD_-G1zQzvXMA7_7Z7Yb-->
					</li> 
					<li>
						<img src="img/NY/recommandImg/leavework/leaveworkImg_3.jpg" class="KeyImg" id="leaveworkList_3">
						<p><span>회사뿌셔</span><br>수연</p>
					<!-- https://music.youtube.com/watch?v=UznsP7hLWKc&list=PLdfZbgOpp0BcOMlmqIgUPvpc_RihX5JsD -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/leavework/leaveworkImg_4.jpg" class="KeyImg" id="leaveworkList_4">
					...
					<li>
						<img src="img/NY/recommandImg/leavework/leaveworkImg_5.jpg" class="KeyImg" id="leaveworkList_5">
						<p><span>때잉뽀</span><br>연소록</p>
					<!-- https://music.youtube.com/watch?v=AAxre3pB4SQ&list=PLjftMfSk54_LrKxY47vzjkb03Ti2EttoP -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/leavework/leaveworkImg_6.jpg" class="KeyImg" id="leaveworkList_6">
						<p><span>백수여름</span><br>A songa</p>
					<!-- https://music.youtube.com/playlist?list=PLn7CZfgDjbV4tuXeTTsAqhvTiDBB8jfcQ -->
					</li> 
					<li>
						<img src="img/NY/recommandImg/leavework/leaveworkImg_7.jpg" class="KeyImg" id="leaveworkList_7">
