...
<body>
	<div class="container">
		...
		<div class="MidSetList" id="ProfileSet">
			...
			<button id="ProfileSet_btn02" class="button" onclick="F_RightPart()">서버 프로필</button>
			...
			<div class="MOProfile" id="ServerProfile">
				<div class="serverP01">
					<p id="serverP_01">참가중인 서버마다 다른 프로필을 사용해 자신을 표현해 보세요.<a href="#"> 서버 프로필에 대해 자세히 알아보기</a></p>
					<p id="serverP_02">서버 선택하기</p>
					<select>
						<!-- 이미지 넣는거 안됌 -->
				        <option data-icon="NY/img/icon/logo_2.png">servername</option>
				        <option><img src="https://source.unsplash.com/random">servername</option>
				        <option><img src="https://source.unsplash.com/random">servername</option>
				        <option><img src="https://source.unsplash.com/random">servername</option>
				      </select>
				</div>
				<div class="serverPNext"> 
					...
					<div class="SleftPart">
						...
						<div class="serverP03">
							<div class="serverP03Inner">
								<p>더 필요하세요? Muinus가 있으면 서버 프로<br>필을 마음껏 맞춤 설정할 수 있어요.</p>
								<button>Muinus로 해제</button>
							</div>
						</div>
